...
// out of the box).
extension ResourceObject: Arbitrary where MetaType: Arbitrary, LinksType: Arbitrary, Description.Attributes: Arbitrary, Description.Relationships: Arbitrary, EntityRawIdType: Arbitrary {
	public static var arbitrary: Gen<ResourceObject<Description, MetaType, LinksType, EntityRawIdType>> {
		return Gen.compose { c in
			ResourceObject(id: c.generate(),
